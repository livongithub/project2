...
let orangeList = document.getElementById('orange')
...
let purpleList = document.getElementById('purple')
let pinkList = document.getElementById('pink')

// adding the image files 
for(i=0; i < itemsList.length; i++) {

  if (itemsList[i].color == "red") {
...
orangeList.addEventListener('click', ()=> {
  console.log('working')
